...
BUSINESS_HOURS_DEFAULT = [
    ...
    (time(8, 0), time(23, 59)), # DEBUG Sunday
]
...
def compute_spread_times(start: datetime, deadline: datetime, runs: int = 3) -> List[datetime]:
    ...
    business_seconds_diff = (deadline_business_seconds - start_business_seconds) / runs
    return [ convert_business_seconds_since_oct1_to_date( int(start_business_seconds + business_seconds_diff * i) ) for i in range(runs) ] 
